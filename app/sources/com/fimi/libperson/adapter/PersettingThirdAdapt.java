...
public class PersettingThirdAdapt extends BaseAdapter {
    ...
    private class ViewHolder {
        ...
        public View initView(ViewGroup parent) {
            View view = LayoutInflater.from(PersettingThirdAdapt.this.mContext).inflate(R.layout.libperson_adapt_person_new_setting, parent, false);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (this.mList != null) {
            ...
            State positionIndex = ((PersonSetting) this.mList.get(position)).getThirdAdapt();
