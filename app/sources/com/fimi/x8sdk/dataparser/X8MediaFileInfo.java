...
public class X8MediaFileInfo {
    ...
    public String toString() {
        return "X8MediaFileInfo{cmdType=" + this.cmdType + ", msg_len=" + this.msg_len + ", error_code=" + this.error_code + ", fileSize=" + this.fileSize + ", nameLen=" + this.nameLen + ", fileName='" + this.fileName + CoreConstants.SINGLE_QUOTE_CHAR + CoreConstants.CURLY_RIGHT;
    }
}
