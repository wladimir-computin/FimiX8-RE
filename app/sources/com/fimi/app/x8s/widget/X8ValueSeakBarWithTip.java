...
public class X8ValueSeakBarWithTip extends RelativeLayout implements OnClickListener, SlideChangeListener {
    ...
    public X8ValueSeakBarWithTip(Context context, AttributeSet attrs) {
        ...
        this.rlTittle = (RelativeLayout) findViewById(R.id.rl_title);
    ...
    public void setRelayoutHeightParam(int height) {
        ((LayoutParams) this.rlTittle.getLayoutParams()).height = height;
    }
